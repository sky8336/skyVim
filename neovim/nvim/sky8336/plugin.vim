...
let plugin_enable_vim_multiple_cursors = 1
...
if filereadable(expand("$HOME/.config/nvim/sky8336/plugin_setting.vim"))    " 判断文件是否存在"
    "echo 'plugin_setting.vim is exists'
    execute 'source ~/.config/nvim/sky8336/plugin_setting.vim'
else
