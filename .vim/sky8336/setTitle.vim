...
func SetTitle()
	if expand("%:e") == 'sh'
		...
		call append(3,"#")
		call append(4,"# Copyright (C) 2018-2023 ning  <ning@company.com>. All Rights Reserved.")
		call append(5,"#")
		call append(6,"# History:")
		call append(7,"#    ".strftime("%Y/%m/%d")." - [ning] Created file")
		call append(8,"#")
		call append(9,"# Maintainer: ning <ning@email.com>")
	...
	elseif expand("%:e") == 'py'
		...
		call append(4,"#")
		call append(5,"# Copyright (C) 2018-2023 ning  <ning@company.com>. All Rights Reserved.")
		call append(6,"#")
		call append(7,"# History:")
		call append(8,"#    ".strftime("%Y/%m/%d")." - [ning] Created file")
		call append(9,"#")
		call append(10,"# Maintainer: ning <ning@email.com>")
	...
	elseif expand("%:e") == 'cpp'
		...
		call append(2," *")
		call append(3," * Copyright (C) 2018-2023 ning  <ning@company.com>. All Rights Reserved.")
		call append(4," *")
		call append(5," * History:")
		call append(6," *    ".strftime("%Y/%m/%d")." - [ning] Created file")
		call append(7," *")
		call append(8," * Maintainer: ning <ning@email.com>")
